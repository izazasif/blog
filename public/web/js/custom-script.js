...
$(document).ready(function(){
   ...
   $(".sponsor-part .hide").hide();

   $(".sponsor-part .theme-btn").click(function(){
        $(".sponsor-part .hide").fadeIn(1500);
        $(".sponsor-part .theme-btn").fadeOut(500);
    });



   $(".testimonials-page .hide").hide();

   $(".testimonials-page .theme-btn").click(function(){
        $(".testimonials-page .hide").fadeIn(1500);
        $(".testimonials-page .theme-btn").fadeOut(500);
    });
});